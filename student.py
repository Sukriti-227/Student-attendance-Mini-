...
class Student:
  # making a constructor
    ...
    # firdob
        img1 = Image.open(r"C:\minproject image\pic1.jpg")
    ...
    #Second img
        img2 = Image.open(r"C:\minproject image\a.jpg")
    ...
    #third img
        img3 = Image.open(r"C:\minproject image\IMG-20241205-WA0009.jpg")
...
#bg image
        img = Image.open(r"C:\minproject image\IMG-20241205-WA0007.jpg")
        ...
        main_frame.place(x=20,y=70,width=1490,height=610)

    #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=730,height=750)

        img_left = Image.open(r"C:\minproject image\cd.jpg")
...
#take a photo sample button
        take_photo_btn=Button(btn_frame1,command=self.generate_datset,text="Take Photo Sample",width=35,font=("times new roman",13,"bold"),bg="blue",fg="white")   
...
#ima    ge in right side
        ...
        img_Right = Image.open(r"C:\minproject image\IMG-20241205-WA0003.jpg")
...
# width
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="sukriti098",database="facial_recognition")
   ...
   # Generate data set or take photo samples
    def generate_datset(self):
        ...
        # Load Predefined data on Face Frontal from opencv
                face_classifier=cv2.CascadeClassifier("C:\Student attendance(Mini)\haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        cv2.putText(face,str(img_id),(50,50),cv2.FONT_HERSHEY_COMPLEX,2,(0,235,0),2)

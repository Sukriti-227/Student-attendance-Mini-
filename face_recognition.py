...
# first iamge
        img_top = Image.open(r"C:\minproject image\Screenshot 2024-12-08 154104.png")
      ...
      # second image 
        img_bottom = Image.open(r"C:\minproject image\Screenshot 2024-12-08 154324.png")
        ...
        b1.place(x=0,y=700,width=300,height=48)

# =======   Attendance ==============
    def mark_attendance(self,i,r,n,d):
        with open ("Sukriti.csv","r+",newline="\n") as f:
